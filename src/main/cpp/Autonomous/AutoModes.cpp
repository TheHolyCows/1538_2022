...
AutoModes::AutoModes()
{
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -3, -21, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 1.33));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -3, -21, 0.2, false, true, INTAKE_SHOOT, CONSTANT("HOOD_DOWN"), true, 1.15));
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -125, 45, 0.5, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -155, 10, 0.45, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -240, -15, 0.3, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -307, -20, 0.2, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 1.75));
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, 4, -25, 0.3, false, false, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 1.83));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, 4, -25, 0.3, false, false, INTAKE_SHOOT, CONSTANT("HOOD_DOWN"), true, 1.5));
