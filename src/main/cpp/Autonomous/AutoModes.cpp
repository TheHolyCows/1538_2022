...
AutoModes::AutoModes()
{
	...
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -30, 0, 0.3, false, true, INTAKE_R_IN, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -40, 0, 0.1, false, true, INTAKE_R_IN, CONSTANT("HOOD_UP"), false, 1));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -10, 10, 0.2, false, true, INTAKE_R_IN, CONSTANT("HOOD_UP"), true, 2));
	// m_Modes["5 Ball"].push_back(RobotCommand(CMD_WAIT, 0, 0, 0, false, true, INTAKE_SHOOT, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 25, 45, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 10, 60, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -2, 75, 0.3, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -10, 95, 0.6, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -75, 110, 0.8, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -95, 120, 0.5, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -180, 130, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -130, 140, 0.3, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -110, 115, 0.4, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -90, 95, 0.4, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -70, 70, 0.3, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
	m_Modes["5 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -50, 50, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_UP"), false, 2));
