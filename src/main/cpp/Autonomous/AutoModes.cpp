...
AutoModes::AutoModes()
{
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -10, -23, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 1));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -10, -23, 0.2, false, true, INTAKE_SHOOT, CONSTANT("HOOD_DOWN"), true, 1.5));
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -120, 45, 0.4, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -190, 10, 0.4, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -245, -15, 0.4, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -310, -20, 0.2, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), false, 2.5));
	...
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -100, 40, 0.4, false, false, INTAKE_STOP, CONSTANT("HOOD_DOWN"), false, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -65, 0, 0.4, false, false, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 6));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -25, -17, 0.2, false, false, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 1.5));
	m_Modes["4 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -25, -17, 0.3, false, false, INTAKE_SHOOT, CONSTANT("HOOD_DOWN"), true, 1.5));
	...
	m_Modes["2 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -47, 0, 0.2, false, true, INTAKE_R_IN, CONSTANT("HOOD_DOWN"), true, 0.3));

	// shoot 2
	m_Modes["2 Ball"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, -30, 6, 0.4, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, 6));
	m_Modes["2 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -20, 12, 0.2, false, true, INTAKE_STOP, CONSTANT("HOOD_DOWN"), true, .75));
	m_Modes["2 Ball"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -20, 12, 0.2, false, true, INTAKE_SHOOT, CONSTANT("HOOD_DOWN"), true, 1));
